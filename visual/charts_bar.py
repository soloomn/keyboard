...
def plot_finger_usage_with_values(data_diktor: dict,
    ...
    Структура данных для каждой раскладки:
        ...
        - 'right': список из 5 значений нагрузок для пальцев правой руки
          [большой, указательный, средний, безымянный, мизинец]
        - 'left_press': список нажатий для пальцев левой руки
        - 'right_press': список нажатий для пальцев правой руки
    ...
    Действия функции:
        ...
        - Добавляет числовые значения нагрузок и нажатий справа от каждого столбца в формате "Ш:{штраф}; Н:{нажатие}"
        ...
        - Устанавливает заголовок "Сравнение штрафов и нажатий на пальцы по раскладкам"
