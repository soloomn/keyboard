...
Модуль содержит централизованный словарь с конфигурацией 7 различных русскоязычных
клавиатурных раскладок и их физическим расположением на клавиатуре.

Основные возможности:
- Хранение данных для 7 раскладок: Диктор, ЙЦУКЕН, ВЫЗОВ, Ант, Скоропись, РусФон, Зубачев
- Указание физического расположения клавиш (ряд и колонка)
- Сопоставление пальцев рук с клавишами для анализа эргономики
...
ant (str): символ(ы) в раскладке "Ант"
skoropis (str): символ(ы) в раскладке "Скоропись"
rusphone (str): символ(ы) в раскладке "РусФон"
zubachew (str): символ(ы) в раскладке "Зубачев"
raw (int): номер ряда клавиатуры (0-3)
column (int): номер колонки клавиатуры (0-12)

РАСПРЕДЕЛЕНИЕ ПАЛЬЦЕВ ПО КОЛОНКАМ:
----------------------------------
column 0-1   - мизинец левой руки (f5l)
column 2     - безымянный левой руки (f4l)
column 3     - средний левой руки (f3l)
column 4-5   - указательный левой руки (f2l)
column 6-7   - указательный правой руки (f2r)
column 8     - средний правой руки (f3r)
column 9     - безымянный правой руки (f4r)
column 10-12 - мизинец правой руки (f5r)

НОМЕРА РЯДОВ:
-------------
raw 0 - верхний ряд цифр и специальных символов
raw 1 - верхний буквенный ряд
raw 2 - средний буквенный ряд (домашний ряд)
raw 3 - нижний буквенный ряд
...
- Некоторые клавиши могут содержать пробелы в значениях для выравнивания
"""
